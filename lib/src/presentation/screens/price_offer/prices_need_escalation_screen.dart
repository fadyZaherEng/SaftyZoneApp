...
class PricesNeedEscalationScreen extends BaseStatefulWidget {
  ...
  @override
  BaseState<PricesNeedEscalationScreen> baseCreateState() =>
      _PricesNeedEscalationScreenState();
}

class _PricesNeedEscalationScreenState
    extends BaseState<PricesNeedEscalationScreen> {
  @override
