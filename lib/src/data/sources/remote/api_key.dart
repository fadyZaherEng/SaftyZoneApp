class APIKeys {
  static const String baseUrl ="https://api.safetyzoone.com";
  ...
  static const String scheduleJobByStatusDate =
      "/api/provider/schedule-job/by-status-date";
  static const String maintenanceAndExtinguisher =
      "/api/provider/schedule-job/maintenance-and-extinguisher";
  static const String certificateOfEquipmentInstallations =
      "/api/provider/certificate-of-equipment-installations";
  static const String goToLocation =
  ...
  static const String firstScreenScheduleJob =
      "/api/provider/schedule-job/{id}";
  static const String secondAndThirdScreenScheduleJob =
      "/api/provider/receive-deliver/{id}";
  static const String fireExtinguisherMainOffer =
      "/api/provider/offer/fire-extinguisher-main-offer";
  static const String createMaintenanceReport =
      "/api/provider/maintenance-report/create";
  static const String maintenanceReportItems =
      "/api/provider/maintenance-report/item-price/{id}";
  static const String maintenanceReports = "/api/provider/maintenance-report";
  static const String createMaintenanceOffer =
      "/api/provider/offer/maintenance-offer";
  static const String installationFeesBulk =
