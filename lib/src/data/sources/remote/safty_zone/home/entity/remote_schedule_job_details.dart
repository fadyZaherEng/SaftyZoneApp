...
part 'remote_schedule_job_details.g.dart';

@JsonSerializable()
class RemoteScheduleJobDetails {
  ...
  const RemoteScheduleJobDetails({
    this.receiveItem,
    this.Id,
    this.provider,
    this.consumer,
  ...
  factory RemoteScheduleJobDetails.fromJson(Map<String, dynamic> json) =>
      _$RemoteScheduleJobDetailsFromJson(json);

  Map<String, dynamic> toJson() => _$RemoteScheduleJobDetailsToJson(this);
}
