...
class _HomeApiServices implements HomeApiServices {
  ...
  Future<HttpResponse<ScheduleJobResponse>> scheduleJobByStatusDate(
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<ScheduleJobResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              '/api/provider/schedule-job/by-status-date',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
    ...
    final value = ScheduleJobResponse.fromJson(_result.data!);
    final httpResponse = HttpResponse(value, _result);
    return httpResponse;
  }
  ...
  Future<HttpResponse<ScheduleJobResponse>> maintenanceAndExtinguisher(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/api/provider/schedule-job/maintenance-and-extinguisher',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HttpResponse<RemoteUpdateStatusDeliver>> receiveDeliverById(
    ...
    _data.addAll(request.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<RemoteUpdateStatusDeliver>>(Options(
      method: 'PUT',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = RemoteUpdateStatusDeliver.fromJson(_result.data!);
    final httpResponse = HttpResponse(value, _result);
    return httpResponse;
  }
  ...
  Future<HttpResponse<RemoteMainOfferFireExtinguisher>>
      fireExtinguisherMainOffer(
          MainOfferFireExtinguisher mainOfferFireExtinguisher) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(mainOfferFireExtinguisher.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<RemoteMainOfferFireExtinguisher>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              '/api/provider/offer/fire-extinguisher-main-offer',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
    ...
    final value = RemoteMainOfferFireExtinguisher.fromJson(_result.data!);
    final httpResponse = HttpResponse(value, _result);
    return httpResponse;
  }
  ...
  Future<HttpResponse<RemoteFirstScreenSchedule>> firstScreenScheduleJob(
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<RemoteFirstScreenSchedule>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = RemoteFirstScreenSchedule.fromJson(_result.data!);
    final httpResponse = HttpResponse(value, _result);
    return httpResponse;
  }
  ...
  Future<HttpResponse<RemoteSecondAndThirdSchedule>>
      secondAndThirdScreenScheduleJob(String id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<RemoteSecondAndThirdSchedule>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = RemoteSecondAndThirdSchedule.fromJson(_result.data!);
    final httpResponse = HttpResponse(value, _result);
    return httpResponse;
  }
  ...
  Future<HttpResponse<RemoteMaintainanceReport>> createMaintenanceReport(
    String token,
    MaintainanceReportRequest maintenanceReport,
  ) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(maintenanceReport.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<RemoteMaintainanceReport>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              '/api/provider/maintenance-report/create',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
    ...
    final value = RemoteMaintainanceReport.fromJson(_result.data!);
    final httpResponse = HttpResponse(value, _result);
    return httpResponse;
  }
  ...
  Future<HttpResponse<List<MaintainanceReports>>> maintenanceReports(
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<HttpResponse<List<MaintainanceReports>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              '/api/provider/maintenance-report',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
    ...
    var value = _result.data!
        .map((dynamic i) =>
            MaintainanceReports.fromJson(i as Map<String, dynamic>))
        .toList();
    final httpResponse = HttpResponse(value, _result);
    return httpResponse;
  }
  ...
  @override
  Future<HttpResponse<dynamic>> createMaintenanceOffer(
      CreateMaintainanceOfferRequest createMaintainanceOfferRequest) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    ...
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/api/provider/offer/maintenance-offer',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HttpResponse<RemoteMaintainanceItemPricesOffer>>
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<RemoteMaintainanceItemPricesOffer>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              '/api/provider/maintenance-report/item-price/${id}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
    ...
    final value = RemoteMaintainanceItemPricesOffer.fromJson(_result.data!);
    final httpResponse = HttpResponse(value, _result);
    return httpResponse;
  }

  @override
  Future<HttpResponse<dynamic>> installationFeesBulk(
    String token,
    RequestBulk requestBulk,
  ) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(requestBulk.toJson());
    final _result =
        await _dio.fetch(_setStreamType<HttpResponse<dynamic>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/api/provider/installation-fees/bulk',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
